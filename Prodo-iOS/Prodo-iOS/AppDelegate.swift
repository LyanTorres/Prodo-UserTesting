...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        if (User.currentUser() == nil) {
            ...
            let initialViewController = storyboard.instantiateViewController(withIdentifier: "SplitViewNav")
            window?.rootViewController = initialViewController
            self.window?.makeKeyAndVisible()
            guard let splitViewController = window?.rootViewController as? UISplitViewController,
                ...
                else { print(" ============= something went wrong in AppDelegate.swift ==============");
                    return false}
    ...
    func applicationWillEnterForeground(_ application: UIApplication) {
        ...
        NotificationCenter.default.post(name: Notification.Name("ConnectedToProdoWifi"), object: nil)
    }
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "Prodo")
